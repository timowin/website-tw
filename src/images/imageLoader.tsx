const imageObjects = {
  ...
  awsCloudEssentialsCertificate: require("./certificates/aws-cloud-essentials.png"),
  awsCloudPractitionerCertificate: require("./certificates/aws-cloud-practitioner.png"),
  bankingKnowledgeCertificate: require("./certificates/bankfachwissen-kompakt.png"),
  interculturalCertificate: require("./certificates/intercultural-competence.png"),
};
